  ...
  namespace Particle
  {
    namespace Interpolator
    {
                                             ...
                                             const typename parallel::distributed::Triangulation<dim>::active_cell_iterator &cell) const
      {
        ...
        {
          dealii::FullMatrix<double> A = new dealii::FullMatrix<dobule> (3,3);
          A = 0;
...
//      void
//      calculate_linear_constants(double *c1, double *c2, double *c3)
//      {
//
//      }
    }
...
namespace aspect
{
  namespace Particle
  {
    namespace Interpolator
    {
      ASPECT_REGISTER_PARTICLE_INTERPOLATOR(LeastSquare,
                                            "least square",
