...
namespace aspect
{
  ...
  namespace InclusionBenchmark
  {
    ...
    template <int dim>
    class TimeDependentAnnulusMaterialModel : public MaterialModel::Interface<dim>
    {
      private:
      ...
      public:
        ...
        declare_parameters (ParameterHandler &prm)
        {
          ...
          {
            prm.enter_subsection("Time dependent annulus material model");
            {
    ...
    /**
      ...
      */
    template <int dim>
    class TimeDependentAnnulusPostprocessor : public Postprocess::Interface<dim>, public ::aspect::SimulatorAccess<dim>
    {
      public:
        /**
        ...
        execute (TableHandler &)
        {
          ...
          if (dynamic_cast<const TimeDependentAnnulusMaterialModel<dim> *>(&this->get_material_model()) != NULL)
            {
              const TimeDependentAnnulusMaterialModel<dim> *
              material_model
