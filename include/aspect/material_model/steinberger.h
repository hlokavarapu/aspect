  ...
  namespace MaterialModel
  {
    ...
    class Steinberger: public MaterialModel::Interface<dim>, public ::aspect::SimulatorAccess<dim>
    {
      ...
      private:
         ...
         * data provided.
         */
        std::vector<std_cxx11::shared_ptr<Modules::MaterialLookup> > material_lookup;

        /**
         * Pointer to an object that reads and processes data for the lateral
         * temperature dependency of viscosity.
         */
        std_cxx11::shared_ptr<Modules::LateralViscosityLookup> lateral_viscosity_lookup;

        /**
         * Pointer to an object that reads and processes data for the radial
         * viscosity profile.
         */
        std_cxx11::shared_ptr<Modules::RadialViscosityLookup> radial_viscosity_lookup;
