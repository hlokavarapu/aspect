...
#ifndef __aspect__particle_conditions_for_injection_h
#define __aspect__particle_conditions_for_injection_h
  ...
  namespace Particle
  {
    ...
    namespace Injector
    {
      ...
      DeclExceptionMsg (ExcParticlePointNotInDomain,
                        ...
                        "Particle::Injector::Interface::generate_particle() function "
      ...
      template <int dim>
      class conditions_for_injection : public SimulatorAccess<dim>
      {
        public:
      ...
      class Interface : public SimulatorAccess<dim>
      {
        public:
          ...
          virtual
          void
          inject_particles(std::multimap<types::LevelInd, Particle<dim> > &particles,
                             types::particle_index global_number_of_particles) = 0;
       ...
       * @ingroup ParticleGenerators
       */
#define ASPECT_REGISTER_PARTICLE_INJECTOR(classname, name, description) \
  template class classname<2>; \
  template class classname<3>; \
  namespace ASPECT_REGISTER_PARTICLE_INJECTOR_ ## classname \
  { \
    aspect::internal::Plugins::RegisterHelper<aspect::Particle::Injector::Interface<2>,classname<2 > > \
    dummy_ ## classname ## _2d (&aspect::Particle::Injector::register_particle_injector<2>, \
                                name, description); \
    aspect::internal::Plugins::RegisterHelper<aspect::Particle::Injector::Interface<3>,classname<3> > \
    dummy_ ## classname ## _3d (&aspect::Particle::Injector::register_particle_injector<3>, \
                                name, description); \
  }
    }
  }
...
#ifndef __aspect__particle_injector_interface_h
