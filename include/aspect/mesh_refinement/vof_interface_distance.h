...
#ifndef __aspect_mesh_refinement_vof_interface_distance_h
#define __aspect_mesh_refinement_vof_interface_distance_h
...
namespace aspect
{
  namespace MeshRefinement
  {
     ...
     */
    template <int dim>
    class VoFInterfaceDistance : public Interface<dim>,
